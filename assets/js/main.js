(function ($) {
    ...
    $('.donate_payment_method li').on('click', function () {
        $('.donate_payment_method li').removeClass('active');
        $(this).addClass('active');
    })

    // donation amount activation
    $('.donate_amount_list li').on('click', function () {
        $('.donate_amount_list li').removeClass('active');
        $(this).addClass('active');
    })
